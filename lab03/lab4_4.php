...
*/
function BCC($n=6, $colorHead="green", $color1="pink", $color2="black")
{
	?>
	<table bgcolor="<?php echo $colorHead;?>">
	<tr bgcolor="<?php echo $color1;?>"><td colspan="3">Bảng cửu chương <?php echo $n;?></td></tr>
	<?php
		for($i=1; $i<=10; $i++)
		{
			?>
			<tr bgcolor="<?php if($i%2==0) echo $color2;?>"><td><?php echo $n;?></td>
				<td><?php echo $i;?></td>
				<td><?php echo $n*$i;?></td>
			</tr>
			<?php
...
// b. Các hàm này không xuất trực tiếp trong hàm mà tổng hợp thành một
// chuỗi và return chuỗi cần xuất
